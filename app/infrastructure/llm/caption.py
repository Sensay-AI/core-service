...
class ChatGPTCaption:
    _caption_template = """
        Create a paragraph of less than 30 words based on the following description : {{ description }} in two languages: {{ primary_language }} and {{ learning_language }} ,use suitable wording and make them sound good, the orignial meaning must be kept and no information can be made up.
    ...
    def rewrite_caption(self, learning_language: str, primary_language: str, caption: str) -> Generator:
